...
_DEFAULTS: dict = {
    ...
    # --- служебный текст ---
    "text_contains": "",       # подстроки (регистр не важен) — основной режим
    "text_masks": "",          # маски (* ?) по всей строке — продвинутый
    "text_fuzzy": "",          # примеры служебных сообщений для нечёткого сравнения
    "fuzzy_threshold": "0.82", # порог похожести 0.1..1.0
    # --- формат ---
    "timezone": "",
